...
- GUI configuration:
  ...
  - 6: Where the progress bar is located, in pixels, and the type of progress bar to use. You can look at the available progress bars [here](https://github.com/AztechMC/Modern-Industrialization/tree/master/src/main/resources/assets/modern_industrialization/textures/gui).
...
- Model configuration. Here you can choose which overlays are available in your machine. The overlays are the machine-specific textures.
  - You can find overlay examples [here](https://github.com/AztechMC/Modern-Industrialization/tree/master/src/main/resources/assets/modern_industrialization/textures/block/machines).
